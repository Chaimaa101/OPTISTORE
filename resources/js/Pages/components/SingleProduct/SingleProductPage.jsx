...
function SingleProductPage() {
    ...
    // Initialize selectedImage with first image or placeholder
    ...
    const handleAddToCart = (e) => {
        ...
        post('/carts', {
            preserveScroll: true,
            onSuccess: () => {
                setSuccess(`${product.title} added to cart successfully!`);
            },
            onError: (errors) => {
                setError(errors.message || "Failed to add to cart");
            },
            onFinish: () => {
                setIsLoading(false);
            }
          ...
          `}
            ...
            <div className="space-y-6">
                ...
                <p className="capitalize text-gray-500 text-sm tracking-wider font-semibold py-2 mb-4">
                    Shop &gt; {product.category?.name} &gt; {product.title}
                </p>
...
SingleProductPage.layout = page => <AppLayout children={page} />;
