...
function SingleProductWomenEyeglasses() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "../../../public/data/Eyeglasses_women/womeneyeglasses.json",
          {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 container max-w-7xl mx-auto px-4 mt-8">
      ...
      <div className="space-y-6">
        ...
        <p className="capitalize text-gray-500 text-sm tracking-wider font-semibold py-2 mb-4">
          Shop &gt; Women&lsquo;s Eyeglasses &gt; {product.name}
        </p>
        <div className="space-y-4">
...
export default SingleProductWomenEyeglasses;
