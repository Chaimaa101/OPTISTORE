      ...
      <div className="flex flex-col gap-y-8  ">
        ...
        >
          ...
          <input
            type="submit"
            value="SUBMIT"
            className="outline-none p-2 bg-white font-bold text-stick h-full border-2 border-white hover:bg-transparent hover:text-white hover:border-2 hover:border-white active:scale-90"
          />
        </form>
      </div>
    </div>
